...
using LibSerialPort, Plots, PlutoUI, DataFrames, CSV, Dates
...
# ╔═╡ e0ee93bc-9c6f-4144-a5c7-ee91c1aea1ce
md"**File Path for Data Export:**"
...
function getSpectrum(port, baud, integrationTime)
...
# ╔═╡ e9964d8f-5931-4fd8-9575-c04d0fa2207c
md"""
$(@bind getspec Button("Get Spectrum"))
"""

# ╔═╡ 1b62c775-ff15-4513-9be7-cb87dc975936
begin
	getspec
	I = getSpectrum(portname, 115200, 10)
end;
...
begin
	getspec
	int_plot = plot(border = :box, grid = false)
	xlabel!(" "); ylabel!("Intensity (a.u.)")
	xlims!(300, 700)
	plot!(spectralData.I, label = "Intensity")
end;

# ╔═╡ 23e2c011-98b3-401c-96fd-c83d0bbceea3
plot(int_plot, layout = (2, 1))
