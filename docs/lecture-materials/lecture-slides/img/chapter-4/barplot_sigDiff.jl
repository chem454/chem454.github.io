...
# ╔═╡ 6121e1a2-1230-11ec-3840-f93737a9cdee
using Plots

# ╔═╡ f9b2ffd1-9b29-4830-aadd-fae86833ca4a
gr()
...
begin
	...
	xlims!(0.5, 3.5); ylims!(0, 6)
end

# ╔═╡ 141a242c-a5bd-4a31-87b3-b9ddb4b034f0
savefig(p, "barplot_sigDiff.png")
