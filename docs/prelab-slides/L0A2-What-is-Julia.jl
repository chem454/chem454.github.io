...
1. Turn in your notebooks by next **Thursday at midnight.**
   - This is the **deadline**!  No late work is accepted after this date!
   - You will get 5% extra credit if you turn an assignment in more than 24 hours before the deadline!
   - This is described in the [latework policy](https://chem370.github.io/course-information/syllabus#late-work).
1. If you run into questions, errors, etc., post a question on Piazza!
"""

# ╔═╡ 30e7c250-610e-11eb-1a73-952c4d24790c
md"""
# Next Three Weeks
- We will work on the UV-vis lab -- we will cover a lot of Chapter 2 (Harvey) in lab next week.
- We will also do lab safety next week.
- If furniture is available in the lab, we will meet on 3rd floor upper level lab; if not, we will be in Biochem lab (here) again.
"""
