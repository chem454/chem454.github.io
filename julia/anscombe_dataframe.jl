...
# ╔═╡ 374d49be-39b4-11eb-2cdf-1fb39c78fcf1
using CSV
...
- How to save a data frame to a CSV file.
...
md"""
Sometimes you may want to write the data frame to a file.  Typically tabular data such as this are stored in plain text files with the extension CSV for *comma-separated values*.
"""

# ╔═╡ 283bbd2c-39b4-11eb-3411-3b124e387828
md"""
## Step 1: Load the `CSV` Package
"""

# ╔═╡ 3c6811c4-39b4-11eb-28c5-2554172df05d
md"""
...
# ╔═╡ 4ca8d23a-39b4-11eb-0253-7157cb4e158f
CSV.write("anscombe.csv", anscombe);
